...
// .wrangler/tmp/bundle-ncd5r8/checked-fetch.js
...
var worker_default = {
  async fetch(request, env) {
    ...
    if (url.pathname.startsWith("/dashboard") || url.pathname.startsWith("/login") || url.pathname === "/" || !url.pathname.includes(".") && !url.pathname.startsWith("/_next")) {
      try {
...
// .wrangler/tmp/bundle-ncd5r8/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ncd5r8/middleware-loader.entry.ts
